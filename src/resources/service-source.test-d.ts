...
import {
  SERVICE_IMAGE_SCHEMA_MATCHES_INTERFACE,
  SERVICE_SOURCE_SCHEMA_MATCHES_INTERFACE,
  type ServiceSource,
...
describe('SERVICE_IMAGE_SCHEMA_MATCHES_INTERFACE', () => {
  it('is the literal true the guard produces', () => {
    expectTypeOf(SERVICE_IMAGE_SCHEMA_MATCHES_INTERFACE).toEqualTypeOf<true>();
  });
});
