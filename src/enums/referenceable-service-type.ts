...
// spec §6.2: `fromService.type` is wider than a service's own type. These six are the values a
// handle in this library produces; Render also publishes `dpg`, `job` and the retired `redis`.
