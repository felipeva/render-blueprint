...
├── .changeset/                      config.json and the pending changesets; `changeset version`
│                                    turns them into the version bump and the changelog entry
